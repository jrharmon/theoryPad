...
(`docs/plan/14-SCALES.md`). Task 1 (the music domain) is committed and awaiting review; the
...
| Scales — pentatonics, blues, harmonic and melodic minor | **in progress** on `scales` — task 1 of 7 done — `docs/plan/14-SCALES.md` |
